...
<section class="products shopping-cart">
   ...
   <h3 class="heading">Keranjang Saya</h3>
   ...
   <form action="" method="post" class="box">
      ...
      <div class="sub-total"> Total Harga : <span>Rp<?= number_format($sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']), 0, ',', '.'); ?></span> </div>
   ...
   <div class="cart-total">
      <p>Total Harga : <span>Rp<?= number_format($grand_total, 0, ',', '.'); ?></span></p>
