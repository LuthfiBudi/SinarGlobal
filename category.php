...
<h1 class="heading">
   Kategori 
   <?= isset($_GET['category']) ? htmlspecialchars($_GET['category']) : '' ?>
</h1>
   ...
   if(isset($_GET['category'])){
      ...
      $select_products = $conn->prepare("SELECT * FROM `products` WHERE `category` = :category ORDER BY id DESC");
   ...
   <form action="" method="post" class="box">
      ...
      <div class="flex">
         ...
         <input type="number" name="qty" class="qty" data-pid="<?= $fetch_product['id']; ?>" min="1" max="99" onkeypress="if(this.value.length == 2) return false;" value="1">
      </div>
