...
<section class="search-form">
   <form action="" method="post">
      <input type="text" name="search_box" placeholder="Cari Disini..." maxlength="100" class="box"
             class="box" autocomplete="off"
             value="<?= isset($_POST['search_box']) ? htmlspecialchars($_POST['search_box']) : '' ?>" required>
